...
place of a count means every column. The brackets are empty because Polars
1.x gives a Python source no name to show there -- a named header,
`PYTHON[...]`, arrives with Polars 2.
